...
export const mockData = {
  ...
  supportedMdmSystems: [
    ...
    { name: "Domo", description: "Gestão empresarial móvel", icon: "Shield" },
    { name: "ItelOS", description: "Restrições por operadora", icon: "Radio" },
    { name: "Tranzact", description: "Bloqueios por plataformas de pagamento", icon: "Smartphone" }
  ],
